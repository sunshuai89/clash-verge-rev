...
export const translationKeys = [
  ...
  'layout.components.navigation.tabs.ssh',
  ...
  'ssh.importSuccess',
  'ssh.exportSuccess',
  'ssh.importDialog.title',
  'ssh.importDialog.urlLabel',
  'ssh.importDialog.urlPlaceholder',
  'ssh.importDialog.passphraseLabel',
  'ssh.importDialog.passphrasePlaceholder',
  'ssh.importDialog.warning',
  'ssh.importDialog.confirm',
  'ssh.importDialog.importing',
  'ssh.exportDialog.title',
  'ssh.exportDialog.passphraseLabel',
  'ssh.exportDialog.passphrasePlaceholder',
  'ssh.exportDialog.hint',
  'ssh.exportDialog.confirm',
  'ssh.exportDialog.exporting',
  'ssh.localPort',
  'ssh.saved',
  'ssh.deleted',
  'ssh.copied',
  'ssh.metrics.latency',
  'ssh.metrics.rate',
  'ssh.metrics.cumulative',
  'ssh.metrics.duration',
  'ssh.metrics.lastActive',
  'ssh.metrics.upload',
  'ssh.metrics.download',
  'ssh.status.stopped',
  ...
  'ssh.status.error',
  'ssh.dialog.addTitle',
  'ssh.dialog.editTitle',
  'ssh.field.name',
  'ssh.field.namePlaceholder',
  'ssh.field.host',
  'ssh.field.port',
  'ssh.field.username',
  'ssh.field.password',
  'ssh.field.passwordEditHint',
  'ssh.field.listenHost',
  'ssh.field.listenHostWarning',
  'ssh.field.localPort',
  'ssh.actions.edit',
  'ssh.actions.delete',
  'ssh.actions.save',
  'ssh.actions.addTunnel',
  'ssh.actions.cancel',
  'ssh.actions.logs',
  'ssh.actions.close',
  'ssh.actions.clear',
  ...
  'ssh.logs.cleared',
  'ssh.errors.required',
  'ssh.errors.passwordRequired',
  'ssh.errors.invalidPort',
  'ssh.errors.importUrlRequired',
  'ssh.errors.passphraseRequired',
